#!/usr/bin/env python3
"""
MP3 Upload Debug Tool (Windows Compatible)
...
def test_mp3_upload():
    ...
    try:
        ...
        print(f"SUCCESS: Upload endpoint response: {response.status_code}")
    except Exception as e:
        print(f"FAILED: Upload endpoint not accessible: {e}")
        return False
    ...
    try:
        ...
        print(f"SUCCESS: Created test MP3 file: {test_file_path}")
        ...
        print(f"FAILED: Upload failed with exception: {e}")
        return False
